        ...
        <?php if(sizeof(Cart::content()) > 0): ?>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-image"><a href="<?php echo e(url('shop', [$item->model->name])); ?>"><img src="<?php echo e(asset($item->model->image)); ?>" alt="product" class="img-responsive cart-image"></a></td>
                        <td><a href="<?php echo e(url('shop', [$item->model->name])); ?>"><?php echo e($item->name); ?></a></td>
                        <td>
            ...
            <?php $__currentLoopData = Cart::content(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form action="<?php echo e(url('/proceedToCheckout', [$item->rowId])); ?>" method="POST">
                <?php echo csrf_field(); ?>
