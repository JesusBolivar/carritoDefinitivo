        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-image"><a href="{{ url('shop', [$item->model->name]) }}"><img src="{{ asset($item->model->image) }}" alt="product" class="img-responsive cart-image"></a></td>
                        <td><a href="{{ url('shop', [$item->model->name]) }}">{{ $item->name }}</a></td>
                        <td>
